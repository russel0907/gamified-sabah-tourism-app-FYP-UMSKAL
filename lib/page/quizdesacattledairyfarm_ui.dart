...
class QuizDesaCattleDairyFarmUI extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _QuizDesaCattleDairyFarmUIState();
  }
}

class _QuizDesaCattleDairyFarmUIState extends State<QuizDesaCattleDairyFarmUI> {
  var _questionIndex = 0;
  var _totalScore = 0;

  final questions_desacattledairyfarm = const [
    {
  ...
  void _answerQuestion(int score) {
    ...
    if (_questionIndex < questions_desacattledairyfarm.length) {
                ...
                Column(
                  children: [
                    Padding(
                      ...
                      child:
                          _questionIndex < questions_desacattledairyfarm.length
                              ? Quiz(
                                  answerQuestion: _answerQuestion,
                                  questionIndex: _questionIndex,
                                  questions: questions_desacattledairyfarm,
                                ) //Quiz
